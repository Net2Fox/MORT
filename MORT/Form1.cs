...
namespace MORT
{
    ...
    public partial class Form1 : Form, IMainFormContract
    {
        ...
        private void TransType_Combobox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            pnOneRingTranslator.Visible = false;
            ...
            else if (TransType_Combobox.SelectedIndex == (int)SettingManager.TransType.oneRingTranslator)
            {
                pnOneRingTranslator.Visible = true;
            }
