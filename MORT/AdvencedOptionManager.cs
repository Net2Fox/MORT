...
namespace MORT
{
    ...
    public class AdvencedOptionManager
    {
        ...
        public const string KeyDeepLXMissuoApiKey = "@DeepLXMissuo_ApiKey ";
        ...
        public class Data
        {
            ...
            //DeepLXMissuo
            public ISettingData<string> DeepLXMissuoApiKey;
        ...
        //DeepLXMissuo
        public static string DeepLXMissuoApiKey => data.DeepLXMissuoApiKey.Value;
        ...
        public static void SetDeepLXMissuoOption(string DeepLXMissuo_api_key)
        {
            data.DeepLXMissuoApiKey.Value = DeepLXMissuo_api_key;
        }
        ...
        private static void LoadTranslatorSetting()
        {
            ...
            data.DeepLXMissuoApiKey = SettingDataFactory.Create<string>(KeyDeepLXMissuoApiKey, data.ParseList, "");
        }
